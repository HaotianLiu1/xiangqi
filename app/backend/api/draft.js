...
function normalizeError(result) {
  ...
  const map = {
    ...
    INVALID_ELEPHANT_SHAPE: 'ERR_INVALID_ELEPHANT_SHAPE',
    ELEPHANT_EYE_BLOCKED: 'ERR_ELEPHANT_EYE_BLOCKED',
    ELEPHANT_CROSS_RIVER: 'ERR_ELEPHANT_CROSS_RIVER',
    INVALID_ADVISOR_SHAPE: 'ERR_INVALID_ADVISOR_SHAPE',
    ADVISOR_OUT_OF_PALACE: 'ERR_ADVISOR_OUT_OF_PALACE',
    INVALID_GENERAL_STEP: 'ERR_INVALID_GENERAL_STEP',
    GENERAL_OUT_OF_PALACE: 'ERR_GENERAL_OUT_OF_PALACE',
    ...
    MOVE_LEAVES_GENERAL_IN_CHECK: 'ERR_MOVE_LEAVES_GENERAL_IN_CHECK'
  };
